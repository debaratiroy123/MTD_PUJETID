...
class JMEFlatTreeProducer : public edm::EDAnalyzer 
{
  ...
  private:  
    ...
    edm::EDGetTokenT<reco::VertexCollection> Dim4recVtxsToken;
    ...
    double minLepPt_,maxLepEta_,minLLMass_,maxLLMass_;
    bool isMC_;
    //---------------------------------------------------
    edm::Service<TFileService> fs_;
    TTree *outTree_; 
    //---- TRIGGER -------------------------  
    TH1F *triggerPassHisto_,*triggerNamesHisto_,*cutFlowHisto_, *candtimerr_, *candtime_, *timediff_, *timediffless3_, *candtimerrpj_, *candtimepj_,  *timediffless3pj_, *timediffpj_, *vtxtime_, *vtxtimerr_, *vtx0timerr_, *vtx0time_;
    ...
    edm::Handle<reco::VertexCollection> Dim4recVtxs;
